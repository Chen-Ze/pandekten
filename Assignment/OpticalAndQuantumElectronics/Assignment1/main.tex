...
Therefore,
\begin{align*}
    f_1(x) &= \frac{1}{2}\qty[F(x) + f_1(0) - f_2(0) - \frac{1}{c}\int_0^x \dd{x'} G(x')], \\
    f_2(x) &= \frac{1}{2}\qty[F(x) - f_1(0) + f_2(0) + \frac{1}{c}\int_0^x \dd{x'} G(x')], \\
    E &= \frac{1}{2}\qty[F(x-vt) + F(x+vt) + \frac{1}{c}\int_{x-vt}^{x+vt} \dd{x'}G(x')].
\end{align*}
